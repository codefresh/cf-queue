...
Queue.prototype.request = function(data) {
    ...
    var requestId;
    if (domain.active && domain.active.requestId) requestId = domain.active.requestId;
...
Queue.prototype.process = function(opts, handler) {
    ...
    var subscribe = function() {
        ...
        var sid = self.connection.subscribe(self.name, {queue:self.name}, function(request, replyTo) {
            ...
            d.run(function() {
                ...
                if (data.requestId) domain.active.requestId = data.requestId;
...
Queue.prototype.subscribe = function(handler) {
    var self = this;
    var sid = self.connection.subscribe(self.name, {}, function(request) {
